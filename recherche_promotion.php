...
?>
		...
		<div id="avec_nav_avec_encadres" class="contenu">
			...
			<p id="fil_ariane">Vous &ecirc;tes ici : <a href="index.php">Accueil</a> &gt; <a href="recherche_promotion.php">Recherche de promotions</a> <span class="separateur_fil_ariane"> </span><strong><span class="titre_fil_ariane">  </span></strong></p>
				...
				&nbsp;
							...
							<script type='text/javascript'>
								...
								<h2 style="text-align: center;"><em><strong>Recherche de promotions</strong></em></h2>

								<!--Connexion à la base de données et requetes pour remplir les listes déroulantes -->
								<?php
								include("../../includes/admin/connexion.php");
								...
								//	$result21= mysql_query($sql2) or die("Requete pas comprise");
								//	$result22 = mysql_query($sql2) or die("Requete pas comprise");
									$result21 = $connexion->prepare("SELECT distinct(trombinoscope.AnneeTrombinoscope) FROM trombinoscope order by AnneeTrombinoscope asc");
									$result21->execute();
									$result22 =$connexion->prepare("SELECT distinct(trombinoscope.AnneeTrombinoscope) FROM trombinoscope order by AnneeTrombinoscope asc");
									$result22->execute();
								...
								<div style="margin-bottom: 20px;">
									<form id="form14" name="form14" method="POST" action="recherche_promotion.php">
										...
										<div style="float: left; margin-right: 20px;">
											<label for="debut_periode">De </label>
											<select name="debut_periode" id="debut_periode"  onchange='go()'>
											<option value="-1" selected>Toutes</option>
											<?php
												while ($row=$result21->fetch())
										...
										<div style="float: left; margin-right: 20px;">
											<label for="fin_periode">à</label>
											<select name="fin_periode" id="fin_periode"  onchange='go()'>
											<option value="-1" selected>Toutes</option>
											<?php
							...
							/* ------------------------------------------------- TRAITEMENT DE LA RECHERCHE DE PROMOTIONS ------------------------------------------------*/
								include("resultat_recherche_promotion.php");
							?>
