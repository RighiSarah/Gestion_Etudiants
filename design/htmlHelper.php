...
class htmlElement{
		...
		foreach($this->attr as $k => $v){
			if($v){
				...
				if($k == "type" && !$this->type){
					...
					$attrHTML .= " required=\"required\" ";					
				}else{ 
					$attrHTML .= " {$k}=\"{$v}\"";
				}
			}
		}
		if ($this->class) $tag .= " class=\"{$this->class}\"";
	...
	*/
	...
	public function isRequired($required=true, $requiredMsg=null) {
		$this->__set("required", $required);
		$this->class .= " required";
		if ($requiredMsg != null && $requiredMsg != "")
			$this->customRequired($requiredMsg);
	}	
	...
	*/
	...
	public function password($name = null,$value = "",$class=null,$attr=array()) {
		return $this->add(new password($name,$value,$class,$attr));
	}
	...
	public function thead($name = null,$class = null,$attr = array()) {
		return $this->add(new thead($name,$class,$attr));
	}
	
	public function tbody($name = null,$class = null,$attr = array()) {
		return $this->add(new tbody($name,$class,$attr));
	}
	...
	public function img($src = null,$alt = null,$title = null,$name = null,$class = null,$attr = array()){
		return $this->add(new img($src,$alt,$title,$name,$class,$attr));
	}
...
class inputTag extends htmlElement{
	...
	public function customRequired($msg) {
		$this->__set("reqMsg", $msg);
		$this->class .= " reqMsg";
	}
}
...
class password extends inputTag {
...
class thead extends genericTag{
	public $tag = "thead";
}

class tbody extends genericTag{
	public $tag = "tbody";
}
...
class img extends htmlElement{
	public function __construct($src = null,$alt = null,$title = null,$name = null,$class = null,$attr = array()){
		$this->tag = "img";
		$this->attr = $attr;
		$this->src = $src;
		$this->alt = $alt;
